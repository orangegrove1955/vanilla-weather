...
window.addEventListener('load', () => {
    ...
    if(navigator.geolocation){
        ...
        error => {
            alert('Sorry, your position could not be found, defaulting to New York');
            lat = 40.730610;
            long = -73.935242;
            getWeather(lat, long);
        },
    ...
    function getWeather(lat, long) {
        ...
        fetch(api)
            ...
            .catch(err => {
                alert('There was a problem getting the current weather, please try reloading the page');
            });
    }
